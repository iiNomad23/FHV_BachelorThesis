...
\begin{document}
	...
	Daher ist es wichtig, dass die Produkte vor der Auslieferung an kaufende Personen gezielt und sorgfältig getestet werden. 
	...
	Dadurch kann stabile Hardware sowie effiziente und gut strukturierte Software an kaufende Person ausgeliefert werden.
	...
	Die Entwicklung technischer Systeme ist ein komplexer Prozess, der eine hohe Qualität für das zu entwickelnde System erfordert, um den Anforderungen der kaufenden Personen gerecht zu werden. 
	...
	Damit die kaufende Person die Funktionalitäten des \ac{TCMS} auch \acfi{UI} unterstützt testen kann, wird ein webbasiertes \ac{UI} von \emph{Swagger} zur Verfügung gestellt, siehe \autoref{fig:swaggeruiExample}.
