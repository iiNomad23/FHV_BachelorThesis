...
\begin{document}
	...
	Um das Ziel dieser Arbeit, ein \ac{TCMS} zu entwickeln, erreicht wird, werden die im \autoref{chapter:requiremnts} auf \autopageref{sec:userStoriesDefinition} definierten User-Stories mithilfe der erwähnten Technologien aus \autoref{sec:technologies} umgesetzt.
