...
\begin{document}
	...
	\section{Einführung in das Test Case Management} \label{sec:tcm}
	\todo{Proper Einführung in das Test Case Management Description}
	...
	Wie in Kapitel \autoref{sec:tcm} auf Seite \pageref{sec:tcm} besprochen worden ist, gibt es zur Unterstützung von Test Case Management-Prozessen sogenannte \aclp{TCMS}.
	...
	\begin{itemize}
		...
		\item \textcite{noauthor_qtest_nodate} 
		
		Eine webbasierte Testmanagementsoftware, die eine einfache und intuitive Oberfläche bietet. 
		QTest ermöglicht es, Testfälle zu planen, durchzuführen und zu verwalten und bietet auch umfangreiche Berichtsfunktionen.
	\end{itemize}

	Diese \ac{TCMS}-Tools bieten eine große Basis Funktionalität und je nachdem andere oder zusätzliche Funktionen und Integrationsmöglichkeiten.
