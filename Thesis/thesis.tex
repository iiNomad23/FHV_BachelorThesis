...
%	\textcite{lead_articles_nodate}	
	...
	\ac{EF} Core ist eine moderne \ac{ORM} Technik für Microsofts .Net Core Technologie (\autoref{subsec:msNetCore}). 
	...
	Mithilfe von einem OpenAI-Code-Generator (\textcite{noauthor_openapi_nodate-1}) kann dann direkt Client-Code für verschiedene Technologien wie z.B. Typescript generiert werden.
