...
\begin{document}
	...
	Durch Methodiken wie zum Beispiel Feature-orientierte Entwicklung ist es möglich, dass bestimmte Features vor dem Release der Produkte abgenommen und getesten werden müssen. 
	...
	Therefore, it's important that products are thoroughly tested before delivery to the customer. 
	...
	Das Aktor-Modell ist ein erstmals in \textcite{hewitt_universal_1973} beschriebenes Berechnungsmodell...
	Diese grundlegende Idee des Aktor-Modells, welches in \cref{sec:stateofart} detailliert beschrieben wird, ermöglicht die 
	\ac{TDD}
	\ac{TDD}
	\textcite[S.10]{george_arnett_foreign_2015}
