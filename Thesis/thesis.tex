...
\begin{document}
	...
	Um eine Testabdeckung sicherzustellen und den allgemeinen Testprozess zu optimieren, gibt es, wie in \autoref{sec:motivation} auf \autopageref{sec:motivation} schon besprochen, \aclp{TCMS}. 
	...
	\section{Blackbox/Whitebox Testing}
	\todo{Proper Blackbox/Whitebox Testing Description}
	
	
	\section{Test Driven Devlopment}
	\todo{Proper Test Driven Devlopment Description}
	...
	Diese \aclp{TCMS} bieten eine große Basis Funktionalität, auf diese wir in \autoref{sec:functionsOfTCMS} auf \autopageref{sec:functionsOfTCMS} genauer eingehen werden, und je nachdem andere oder zusätzliche Funktionen und Integrationsmöglichkeiten.
	...
	\subsection{Allgemeine Vorteile von Test Case Management Systemen} \label{subsec:benefitsOfTCMS}
	\todo{Proper Vorteile von Test Case Management Systemen Description}
	
	
	\section{Features von Test Case Management Systemen} \label{sec:functionsOfTCMS}
	...
	\todo{Proper Verwendete Technologien Description}
	...
	\subsection{Microsoft .NET Core}
	\todo{Proper .NET Core Description}
	
	\subsection{Microsoft ASP.NET Core}
	\todo{Proper ASP.NET Core Description}
	
	\subsection{Entity Framework Core}
	\todo{Proper Entity Framework Core Description}
	
	\subsection{OpenAPI}
	\todo{Proper OpenAPI Description}
