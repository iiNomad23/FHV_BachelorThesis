...
\begin{document}
	...
	\begin{itemize}
		...
		Um zu zeigen, wie die Konfiguration der Tabellen mit \ac{EF} Core funktioniert wird bei dieser User-Story detailliert darauf eingegangen (Siehe: \autoref{subsec:createAndSearchTestplans} auf \autopageref{subsec:createAndSearchTestplans}).
