...
\begin{document}
	...
	\begin{figure}[H]
		...
		\caption{Liste von aktuell führenden Test Case Management Systemen/Tools (Quelle: \cite[][]{noauthor_7_nodate})}
		\label{fig:tcms_logo}
	\end{figure}
	
	Die in Abbildung \ref{fig:tcms_logo} ersichtlichen Tools zeigen eine aktuell führende Auswahl von beliebten \aclp{TCMS}n.  
	
	\subsection{Funktionen und Eigenschaften von Test Case Management Systemen} \label{subsec:functionsOfTCMS}
