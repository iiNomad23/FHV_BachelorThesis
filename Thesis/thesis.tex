...
\begin{document}
	...
	Bei einem \acfi{MVP} handelt es sich um die erste funktionierte Iteration eines Produkts das nur Kernfunktionalitäten beinhaltet.
	...
	Vor der Modellierung wurde eine Übersicht von dem schon bestehenden \acfi{TAS} verschafft, dargestellt in \autoref{fig:testAutomationSystem}.
