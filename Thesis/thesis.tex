...
\begin{document}
	...
	Damit der Kunde die Funktionalitäten des \ac{TCMS} auch \acfi{UI} unterstützt testen kann, wird ein webbasiertes \ac{UI} von \emph{Swagger} zur Verfügung gestellt (Siehe: \autoref{fig:swaggeruiExample}).
	...
	Die Akzeptanzkriterien sind wie folgend:
	\begin{itemize}
		\item Erstellen von Test-Environments über die Swagger-UI
		\item Suchen von Test-Environments über die Swagger-UI
		\item Zuordnungsmöglichkeit von Testplänen über die Swagger-UI
	\end{itemize}
	...
	Die Akzeptanzkriterien sind wie folgend:
	\begin{itemize}
		\item Erstellen von Testplänen, Testfällen und Testimplementationen über die Swagger-UI
		\item Suchen von Testplänen, Testfällen und Testimplementationen über die Swagger-UI
		\item Zuordnungsmöglichkeit von Testfällen und Testimplementationen über die Swagger-UI
	\end{itemize}
	...
	Die Akzeptanzkriterien sind wie folgend:
	\begin{itemize}
		\item Erstellen von Testläufen über die Swagger-UI
		\item Suchen von Testläufen über die Swagger-UI
		\item Zuordnungsmöglichkeit von Testläufen über die Swagger-UI
	\end{itemize}
	...
	In dieser Arbeit haben wir uns für eine Schichtenarchitektur mit \acfi{DDD} entschieden, da sich aus meiner Erfahrung diese Architektur bewährt und es gute Erfahrungen damit gab.
